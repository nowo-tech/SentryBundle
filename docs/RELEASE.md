...
- [Example: releasing 1.3.2](#example-releasing-132)
...
git add docs/CHANGELOG.md docs/UPGRADING.md README.md docs/CONFIGURATION.md docs/USAGE.md docs/RELEASE.md
git commit -m "docs: prepare release 1.6.0"
