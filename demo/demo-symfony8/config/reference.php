 ...
 * }
 * @psalm-type NowoSentryConfig = array{
 *     request_listener?: bool|array{
 *         enabled?: bool, // Default: true
 *         set_domain_tag?: bool, // Whether to set the domain tag in Sentry scope // Default: true
 *         set_environment_tag?: bool, // Whether to set the environment tag in Sentry scope // Default: true
 *         set_user_info?: bool, // Whether to set user information in Sentry scope // Default: true
 *         set_session_id?: bool, // Whether to set session ID in Sentry scope extra data // Default: true
 *         priority?: int, // Event listener priority // Default: 0
 *     },
 *     ignore_access_denied_listener?: bool|array{
 *         enabled?: bool, // Default: true
 *         priority?: int, // Event listener priority (higher = earlier execution) // Default: 255
 *     },
 *     uptime_bot_listener?: bool|array{
 *         enabled?: bool, // Default: true
 *         user_agents?: list<scalar|null>,
 *         paths?: list<scalar|null>,
 *         priority?: int, // Event listener priority (higher = earlier execution) // Default: 255
 *     },
 * }
